...
public class DatabaseFederationProvider implements UserStorageProvider,
        UserLookupProvider,
    ...
    private static final Logger logger = Logger.getLogger(DatabaseFederationProvider.class);
    ...
    DatabaseFederationProvider(KeycloakSession session, ComponentModel model) {
        this.session = session;
        this.model = model;
        em = session.getProvider(JpaConnectionProvider.class, "user-dbstore").getEntityManager();
    }
